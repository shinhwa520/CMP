...
public class FilesReference {
	...
	public FilesReference() {
		super();
	}

	public FilesReference(Integer seqNo, String upperFileName, String originFileName, String fileName,
			String fileExtension, String fileDescription, Integer fileSize, Integer downloadTimes, Timestamp createTime,
			String createBy, Timestamp updateTime, String updateBy, FilesSetting filesSetting, Integer referenceId) {
		super();
		this.seqNo = seqNo;
