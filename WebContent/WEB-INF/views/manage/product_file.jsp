...
<SCRIPT type="text/javascript">
	...
	function doDelete() {
		...
		if (!haveOneChecked) {
			...
			FileForm.action = "${pageContext.request.contextPath}/manage/productFile/delete";
...
<section class="content">
	<div class="row page-titles">
	     <div class="col-md-6 col-8 align-self-center">
	         <h3 class="text-themecolor m-b-0 m-t-0"><spring:message code="productFileMaintain" /></h3>
	     </div>
	</div> 
...
function btnEditClicked(btn) {
	...
	$.ajax({
			url : '${pageContext.request.contextPath}/manage/productFile/' + formAction,
			data : {
...
function btnDownloadClicked(btn) {
	var downloadUrl = "${pageContext.request.contextPath}/manage/productFile/download?seqNo="+btn.attr('seqNo')+"&fileType="+btn.attr('fileType')+"&fromPage=manage/productFile";
